...
Scene initScene1() {
	...
	sphere2->material.refractionIndex = 1; //glass
	sphere2->material.transmittance = 1;
	sphere2->material.diffuse = vec3(0.6, 0.0, 0.0);
	sphere2->material.specular = 1.0f * sphere1->material.diffuse;
	sphere2->material.reflectionStrength = vec3(0.4);
	sphere2->material.specularCoefficient = 64;
	//ene1.shapesInScene.push_back(sphere2);
